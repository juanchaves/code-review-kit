...
def workflow_contract_lines(name: str) -> list[str]:
    return [
        ...
        "9. For Azure DevOps automation, prefer the `azure-devops-cli` skill/agent path before falling back to raw `az` commands.",
        "10. End by asking the user to choose one next action:",
